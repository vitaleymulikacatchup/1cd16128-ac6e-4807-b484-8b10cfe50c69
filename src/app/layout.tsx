...
export const metadata: Metadata = {
  title: "Pizzeria - Taste the Best Pizza in Town",
  description: "Discover our delicious pizzas made with fresh ingredients and experience the best dining.",
  keywords: "pizza, pizzeria, best pizza, fresh ingredients, delicious pizza",
  metadataBase: new URL("https://yourpizzeria.com"),
  alternates: { canonical: "https://yourpizzeria.com" },
  openGraph: {
    title: "Pizzeria - Taste the Best Pizza in Town",
    description: "Discover our delicious pizzas made with fresh ingredients and experience the best dining.",
    url: "https://yourpizzeria.com",
    siteName: "Pizzeria",
